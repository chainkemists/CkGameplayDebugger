...
|---|---|---|---|---|
| [0](PHASE_0.md) | Verification spike & contract lock | scratch only + campaign docs | 1 | ⏳ Pending |
| [1](PHASE_1.md) | Timing surface in CkProfile | `CkFoundation/Source/CkProfile` | 2 | ⏳ Pending |
| [2](PHASE_2.md) | CkPerfLab module: session model, stats, codec | new `CkGameplayDebugger/Source/CkPerfLab` | 2 | ⏳ Pending |
