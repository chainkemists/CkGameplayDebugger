...
41. **Per-pixel identity comes from batched CustomDepth-Stencil passes stored WITH the image** (settled in P10's
    planning, implementation pending in P11). Hover and selection must work on a stored snapshot after the world has
