...
| **Status** | P0 done (98/98); P1 done (103/103); P2 done (107/107); P3 done (111/111); P4 done (gate deferred into P5's); P5 done; P6 done (123/123) — **all six phases implemented**. P7 (review fixes, 2026-08-11) done (126/126) — **campaign complete**; remaining work is the [EDITOR-VERIFY] walkthroughs in CLAUDE.md and shipping. |
...
29. **A redirector row is labelled with its referencer COUNT, not its destination** (settled in P6). Reading a
