...
#include "CkGoapDebugGraphSchema.generated.h"

// ====================================================================================================================
// Read-only schema for the CkGoapDebugger action graph. No user-initiated
// node creation, no pin-drag, no break-link. Empty context-menu (Copy
// entries are added per-node via SCkDebug_NodePill's CopyText path).
// CreateConnectionDrawingPolicy returns FCkGoapDebugConnectionPolicy.
// ====================================================================================================================

UCLASS()
class CKGOAPDEBUGGER_API UCkGoapDebugGraphSchema : public UEdGraphSchema
{
    GENERATED_BODY()
