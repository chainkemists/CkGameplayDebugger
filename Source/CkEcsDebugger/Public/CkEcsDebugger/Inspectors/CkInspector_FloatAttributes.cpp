...
auto FCkInspector_FloatAttributes::BuildAttributeGrid(const FCk_Handle& Entity, const FString& InFilter) -> TSharedRef<SWidget>
{
    ...
    UCk_Utils_FloatAttribute_UE::ForEach(MutableEntity, [&Builder, WeakSelectionModel](FCk_Handle_FloatAttribute InAttribute)
    {
        ...
        attribute_rows::Add_OverrideRows<UCk_Utils_FloatAttribute_UE>(
            Builder, AttributeName, InAttribute);

        attribute_rows::Add_RefillRows<UCk_Utils_FloatAttribute_UE, UCk_Utils_FloatAttributeRefill_UE>(
            Builder, AttributeName, InAttribute);

        attribute_rows::Add_ModifierRows<UCk_Utils_FloatAttribute_UE, UCk_Utils_FloatAttributeModifier_UE>(
            Builder, AttributeName, InAttribute);
    });
