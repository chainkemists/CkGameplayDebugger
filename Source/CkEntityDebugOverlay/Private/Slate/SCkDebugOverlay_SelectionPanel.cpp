...
auto SCkDebugOverlay_SelectionPanel::Build_PresentationSection() -> TSharedRef<SWidget>
{
    ...
    Content->AddSlot().AutoHeight()[Make_ToggleRow(FText::FromString(TEXT("Outline selected entity")), TAttribute<bool>::CreateLambda([](){ return UCk_DebugOverlay_SelectionSettings::Get()->Get_Config().OutlineSelected; }), [this](bool V){ Mutate_Config([V](auto& C){ C.OutlineSelected = V; }); })];
