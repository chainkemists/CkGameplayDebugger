    ...
    UCk_Utils_ByteAttribute_UE::ForEach(MutableEntity, [&Builder, WeakSelectionModel](FCk_Handle_ByteAttribute InAttribute)
    {
        ...
        Builder.AddClickableRow(
            ...
            [CapturedTag, HasMin, HasMax](const FCk_Handle& E)
            {
                ...
                const auto Base = UCk_Utils_ByteAttribute_UE::Get_BaseValue(Attr, ECk_MinMaxCurrent::Current);
                ...
                if (HasMin && HasMax)
                {
                    const auto MinVal = UCk_Utils_ByteAttribute_UE::Get_FinalValue(Attr, ECk_MinMaxCurrent::Min);
                ...
                const auto PreClamp = UCk_Utils_ByteAttribute_UE::Get_PreClampFinalValue(Attr);
                if (PreClamp > Final)
