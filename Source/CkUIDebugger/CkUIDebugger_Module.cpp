...
auto FCkUIDebuggerModule::StartupModule() -> void
{
    ...
    _EnginePreExitHandle = FCoreDelegates::OnEnginePreExit.AddRaw(this, &FCkUIDebuggerModule::HandleEnginePreExit);
}
...
auto FCkUIDebuggerModule::HandleEnginePreExit() -> void
{
