...
auto
    ...
    -> void
{
    // Completely disabled — all actions live in the detail panel instead.
    // Not calling Super suppresses the default pin/link actions that were
    // causing the graph to freeze after right-click.
}
